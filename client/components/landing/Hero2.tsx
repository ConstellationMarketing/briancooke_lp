export function Hero2() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: 'url(https://cdn.builder.io/api/v1/image/assets%2Fc8a7b33c1f3e4309983e45cabed92535%2F8233df74b78b49a5867a9af5e1f48313?format=webp&width=800)',
      }}
    >
