      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="font-pt-sans text-base sm:text-lg text-gray-800 leading-relaxed max-w-3xl mx-auto">
            ...
            "Rising Star" by SuperLawyers Magazine, was awarded "10 Best in
            Client Satisfaction" for DWI cases in Missouri, and the Client's
            choice award by Avvo.com. Brian is a member of the Missouri
            Association of Criminal Defense Attorneys, The National Association
            of Criminal Defense Attorneys, and the National College for DWI
            defense.
          </p>
        </div>
