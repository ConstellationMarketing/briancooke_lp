export function Hero() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url(https://cdn.builder.io/api/v1/image/assets%2Fc8a7b33c1f3e4309983e45cabed92535%2Fa20fd3c7a4a842c7a353e617a6076f53?format=webp&width=800)",
      }}
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://cdn.builder.io/api/v1/image/assets%2Fc8a7b33c1f3e4309983e45cabed92535%2F0291ac0610ef4115816f25d0e935e3da?format=webp&width=800)",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-white z-10">
            ...
            <p className="font-poppins text-xl sm:text-2xl font-bold leading-relaxed mb-8">
              DWI defense isn't just part of our practice — it's what we're
              known for.
            </p>
